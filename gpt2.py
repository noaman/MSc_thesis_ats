...
def generate_summary(text):
    ...
    inputs = tokenizer.encode_plus(
        ...
        max_length=1024, 
        truncation=True,
        padding='max_length',  # This will pad the sequence up to max_length
    ...
    # Generate summary using pad_token_id and attention_mask
...
df1.to_csv('summaries_gpt2.csv', index=False)